...
class _HomeState extends State<Home> {
  ...
  final Map<String, List<double>> _rumus = {
  ...
  void hitungKonversi(
    ...
    if (nomorSatuanAwal != null && nomorSatuanTujuan != null) {
      var faktorPengali =
          _rumus[nomorSatuanAwal.toString()]![nomorSatuanTujuan];
          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                onChanged: (text) {
                  setState(() {
                    _nilaiInput = double.tryParse(text) ?? 0.0;
                  });
                },
              ),
              Spacer(),
